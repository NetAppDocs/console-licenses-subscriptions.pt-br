...
summary: Veja os detalhes do contrato para cada um dos seus clusters ONTAP locais. 
---
...
[role="lead"]
No NetApp Console, você pode descobrir um cluster ONTAP e visualizar os detalhes do contrato para cada cluster ONTAP local que você descobriu.
