...
. No menu do NetApp Console , selecione *Administração > Licenses and subscriptions*.
. Selecione * Assinaturas Keystone *.
. Para a assinatura que você deseja vincular, selecione image:icon-action.png["Um ícone que tem três pontos lado a lado"] e selecione *Vincular*.
...
. No menu do NetApp Console , selecione *Administração > Licenses and subscriptions*.
. Selecione * Assinaturas Keystone *.
. Para a assinatura cuja capacidade você deseja ajustar, selecione image:icon-action.png["Um ícone que tem três pontos lado a lado"] e selecione *Ver detalhes e editar*.
. Insira a capacidade comprometida solicitada para uma ou mais assinaturas.
. Desça a página, insira quaisquer detalhes adicionais para a solicitação e selecione *Enviar*.
...
. No menu do NetApp Console , selecione *Administração > Licenses and subscriptions*.
. Selecione * Keystone*.
. Para a assinatura que deseja desvincular, selecione image:icon-action.png["Um ícone que tem três pontos lado a lado"] e selecione *Desvincular*.
