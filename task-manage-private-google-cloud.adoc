...
summary: Aceite uma oferta privada do Marketplace para a listagem do NetApp Console no console do Google Cloud.  Configure as credenciais do Google Cloud no Console. 
---
...
. Confirme se as informações estão corretas, aceite os termos e selecione **Accept**.
...
. Selecione **REGISTRAR-SE NA NETAPP, Inc.**. Você será redirecionado para o NetApp Console para concluir a configuração da sua assinatura. Se a oferta privada foi aceita por outra pessoa em sua organização:
+
.. No Google Cloud Marketplace, acesse **Pedidos**.
.. Localize a oferta com status **Pendente**.
.. Selecione o menu de três pontos e selecione **Registrar-se na NetApp, Inc.**
...
.. Selecione as *Organizations* do NetApp Console que devem ter acesso à assinatura.
.. Opcionalmente, você pode ativar a opção **Substituir assinatura existente** se desejar substituir automaticamente uma assinatura existente Marketplace em uma organização NetApp Console.
+
[NOTE]
====
