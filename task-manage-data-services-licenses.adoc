...
As informações de licença são exibidas automaticamente na seção **Licenses and subscriptions** se a conta do NetApp Console associada à licença também for uma conta do NetApp Support Site. Se você usou uma conta do Console que não está associada à sua conta do NSS, será necessário adicionar uma licença manualmente.
