...
.. Opcionalmente, você pode ativar *Substituir assinatura existente* para substituir automaticamente uma assinatura existente do Marketplace em uma organização do Console.
+
[NOTE]
====
