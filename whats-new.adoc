...
=== Gerenciando licenças do Cloud Volumes ONTAP

Agora você gerencia as licenças do Cloud Volumes ONTAP pela página inicial ou pela aba *Licenças diretas*. Use a aba *Assinaturas do Marketplace* para visualizar as informações da sua assinatura.
...
https://docs.netapp.com/us-en/console-setup-admin/task-monitor-cm-operations.html["Aprenda a configurar notificações por e-mail"^]
...
A Carteira Digital agora mostra a capacidade total consumida em sua conta e a capacidade consumida por pacote de licença. Isso pode ajudá-lo a entender como você está sendo cobrado e se precisa adquirir capacidade adicional.
