...
NOTE: Você precisa de um agente do Console implantado para visualizar informações de assinatura. Um agente também é necessário para visualizar licenças BYOL para o Cloud Volumes ONTAP.
...
* https://docs.netapp.com/us-en/data-services-backup-recovery/index.html["Backup e Recuperação"^]
* https://docs.netapp.com/us-en/data-services-cloud-tiering/index.html["Camadas de nuvem"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/index.html["Cloud Volumes ONTAP"^]
* https://docs.netapp.com/us-en/data-services-disaster-recovery/index.html["Recuperação de desastres"^] (apenas BYOL)
* https://docs.netapp.com/us-en/data-services-ransomware-resilience/index.html["Resiliência ao Ransomware"^]
