...
---
= Gerencie o licenciamento baseado em capacidade para Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Se você planeja faturar a capacidade do Cloud Volumes ONTAP por meio da assinatura independente do Cloud Volumes ONTAP no AWS Marketplace, o sistema Cloud Volumes ONTAP deve usar um pacote baseado em capacidade compatível (Essentials ou Freemium). O pacote Professional não é compatível com a listagem independente e continua sendo faturado por meio da assinatura NIS. Depois de selecionar o pacote desejado, use *Preferências de faturamento* no NetApp Console para escolher a assinatura do Marketplace usada para o faturamento do Cloud Volumes ONTAP.
...
| Capacidade pré-comprometida total | A capacidade total licenciada que você adquiriu da NetApp, incluindo licenças BYOL e contratos do Marketplace. Este valor é a soma da capacidade total de licenças BYOL e da capacidade total dos contratos do Marketplace. 
