...
[role="lead"]
O painel *Visão geral* no NetApp Console ajuda você a monitorar o status de suas licenças e assinaturas para garantir que você possa gerenciar custos e manter o serviço à medida que as assinaturas se aproximam das datas de vencimento ou dos limites de capacidade.
...
+
Não é possível adicionar novas licenças ou assinaturas na página *Visão geral* de um serviço específico. Você só pode adicionar licenças na aba *Licenças diretas* ou assinaturas na aba *Assinaturas do Marketplace*.
...
+
** link:task-manage-data-services-licenses.html["Saiba mais sobre o gerenciamento de licenças"].
** link:task-manage-subscriptions.html["Saiba mais sobre como gerenciar assinaturas"].
